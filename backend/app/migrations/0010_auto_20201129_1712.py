...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='event',
            name='organizer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='app.organizer'),
        ),
        migrations.AlterField(
            model_name='event',
            name='water_temp',
        ...
        migrations.AlterField(
            model_name='event',
            name='water_type',
            field=models.CharField(blank=True, choices=[('river', 'River'), ('sea', 'Sea'), ('lake', 'Lake')], max_length=10, null=True),
        ),
        migrations.AlterField(
            model_name='event',
            name='website',
        ...
        migrations.AlterField(
            model_name='race',
            name='wetsuit',
            field=models.CharField(blank=True, choices=[('compulsory', 'Compulsory'), ('optional', 'Optional'), ('prohibited', 'Prohibited')], max_length=10, null=True),
        ),
    ]
